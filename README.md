# Klaysafe Safe Deployments

[![npm version](https://badge.fury.io/js/%40klaysafe.pm%2Fsafe-deployments.svg)](https://badge.fury.io/js/%40klaysafe.pm%2Fsafe-deployments)

This contract contains a collection of deployments of the contract of the [Safe contracts repository](https://github.com/klaysafe/safe-contracts). 
...
To add additional deployments please follow the [deployment steps in the Safe contract repository](https://github.com/klaysafe/safe-contracts#deployments).

## Install
- npm - `npm i @klaysafe.pm/safe-deployments`
- yarn - `yarn add @klaysafe.pm/safe-deployments`
...
interface SingletonDeployment {
    defaultAddress: string, // Address the contract was deployed to by the Klaysafe team
    version: string,
    abi: any[],
